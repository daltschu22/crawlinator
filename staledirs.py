...
def main():
    ...
    # structure = get_directory_structure(og_path)

    # pp.pprint(structure)

    clean_path = os.path.abspath(og_path)
    ...
    # path_class = FileSystem(clean_path)

    
    # pp.pprint(path_class.full)

    # for dir in path_class.full['dirs']:
    #     print(dir['fullpath'])
    # #     path_class.walk_dir(dir)
